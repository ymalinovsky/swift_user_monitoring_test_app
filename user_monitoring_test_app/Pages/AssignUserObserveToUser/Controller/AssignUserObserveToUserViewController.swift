...
class AssignUserObserveToUserViewController: UIViewController {
    ...
    @IBAction func yesButtonAction(_ sender: UIButton) {
        ...
        NotificationCenter.default.post(name: .userObservedListVCRemoveItemFromAssignUserObserveToUserQueue, object: nil, userInfo: [observedUserID: ["observedUserID": observedUserID]])
